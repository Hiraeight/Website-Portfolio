...
const FloatingDockMobile = ({
  ...
  return (
    <div className={cn("fixed bottom-0 left-0 right-0 block md:hidden z-50", className)}>
        <AnimatePresence>
            {open && (
            <motion.div
                layoutId="nav"
        ...
        <button
            ...
            className="h-10 w-10 rounded-full bg-[#171717] dark:bg-neutral-800 flex items-center justify-center"
            >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "fixed bottom-4 left-1/2 transform -translate-x-1/2 hidden md:flex h-16 gap-4 items-end rounded-2xl bg-[#171717] px-4 pb-3 z-50",
        className
      )}
    >
      {items.map((item) => (
