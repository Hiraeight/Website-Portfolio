    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="font-sans text-zinc-400 dark:text-neutral-300 text-base md:text-lg max-w-sm">
          Here is a timeline of my journey as a developer.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-white dark:text-neutral-500 text-glow">
                {item.title}
              </h3>
            </div>
